...
public abstract class CameraActivity extends AppCompatActivity
  ...
  protected void onCreate(final Bundle savedInstanceState) {
    ...
    findViewById(R.id.camera_change_button).setBackgroundResource(
        !Settings.getInstance().isIsfront() ? R.drawable.ic_camera_front_black_24dp
            : R.drawable.ic_camera_rear_black_24dp);
    findViewById(R.id.camera_change_button).setOnClickListener(this);
...
//        processImage(); // todo remove
  ...
  public void onClick(View v) {
    ...
    if (v.getId() == R.id.camera_change_button) {
